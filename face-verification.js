...
function renderStepScreen(){
  ...
  var dirRow = STEPS.map(function(s,i){
  ...
  body.innerHTML =
    ...
    +'</div>'
    +'<div class="fvStepLabel">Step '+(FV.stepIndex+1)+' of '+STEPS.length+'</div>'
    +'<div class="fvHeading" id="fvHeading">'+step.label+'</div>'
    +'<div class="fvSub" id="fvSub">'+step.instr+'</div>'
    +'<div class="fvDirRow">'+dirRow+'</div>'
