/* ══════════════════════════════════════════════════════════════════
   ...
   sets up: sb, currentUser, toast, nav, copyToClipboard, openMoreSheet)
...
async function loadReferralPage(){
  ...
  try{
    ...
    if(codeEl)codeEl.textContent=currentUser.referral_code||'—';
...
function copyReferralLink(){
  var linkEl=document.getElementById('referLink');
  if(linkEl&&linkEl.textContent)copyToClipboard(linkEl.textContent);
}
function copyReferralCode(){
  if(currentUser&&currentUser.referral_code)copyToClipboard(currentUser.referral_code);
}
